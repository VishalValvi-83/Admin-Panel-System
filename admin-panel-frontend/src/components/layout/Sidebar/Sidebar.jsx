...
export const Sidebar = ({
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-40 w-64 p-4 shadow-lg bg-gradient-to-r from-[#1e3b6b] to-[#10172c] transform transition-transform duration-300 md:relative md:translate-x-0 md:flex md:flex-shrink-0 md:w-56 lg:w-64
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              ...
              <ul
                className={`pl-4 mt-2 overflow-hidden transition-all font-medium text-gray-300 text-sm duration-300 ease-in-out rounded-lg bg-gradient-to-r from-[#1e3b6b] to-[#10172c] 
